...
*/
//=======================================================================================
public class sltLog implements DataSource {
  ...
  public sltLog(String driver, String URL, String login, String password){
    this.driver = driver;
    this.URL = URL;
    this.login = login;
  ...
  public static void main(String args []) throws Exception {
    ...
    */
    ...
    sltLog ds = new sltLog("com.ibm.db2.jcc.DB2Driver", "jdbc:db2://db2:55100/LIVEE_11", "XYZ", "passw");
